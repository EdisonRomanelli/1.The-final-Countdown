...
Serial.println("Entrou em receivePDU");
    ...
    switch (fcode) {
        ...
        #endif
        default:
			Serial.println("		default: this->exceptionResponse(fcode, MB_EX_ILLEGAL_FUNCTION);");
            this->exceptionResponse(fcode, MB_EX_ILLEGAL_FUNCTION);
    }
	Serial.println("	Fim do switch");
}
