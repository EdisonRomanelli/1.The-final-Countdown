...
byte PinosLinhasNUM[LINHASnum] = {19,18,5,17};
byte PinosColunasNUM[COLUNASnum] = {16,4,0};
...
byte PinosLinhasCMD[LINHAScmd] = {17};
byte PinosColunasCMD[COLUNAScmd] = {16,0};
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Verifica se foi apertado algum botão de comando (* ou #)
  ...
  if (comando != NO_KEY) Serial.println(comando);
